...
const textForNextPred = "Вы получите следующее предсказание для вашего зодиака завтра в %d:%s. Вы можете в любой момент отменить ежедневный прогноз в соответствующем пункте меню.";

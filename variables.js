...
const textForNextPred = "Вы будете получать предсказание для вашего зодиака каждый день (включительно сегодняшний) в %d:%d. Вы можете в любой момент отменить ежедневный прогноз в соответствующем пункте меню.";
